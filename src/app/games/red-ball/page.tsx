...
import { RedBallGame } from "@/components/projects/red-ball-game";

export const metadata: Metadata = {
  title: "Red Ball",
  description: "Play the retro Red Ball platformer — jump, dodge spikes, collect coins!",
};
    ...
    <main style={{ maxWidth: "52rem", margin: "0 auto", padding: "2.5rem 1.5rem" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "1rem", marginBottom: "1.5rem" }}>
        <div>
          ...
          <h1 className="gradient-text" style={{ fontSize: "1.75rem", fontWeight: 700, marginTop: "0.5rem" }}>Red Ball</h1>
        </div>
