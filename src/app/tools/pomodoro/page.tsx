...
export const metadata: Metadata = {
  ...
  description: "Stay focused with a beautiful Pomodoro timer featuring circular progress and session tracking.",
};
    ...
    <main style={{ maxWidth: "72rem", margin: "0 auto", padding: "2.5rem 1.5rem" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "1rem", marginBottom: "1.5rem" }}>
        <div>
          ...
          <h1 className="gradient-text" style={{ fontSize: "1.75rem", fontWeight: 700, marginTop: "0.5rem" }}>Pomodoro Timer</h1>
        </div>
