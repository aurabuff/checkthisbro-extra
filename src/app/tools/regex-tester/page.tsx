...
export const metadata: Metadata = {
  title: "Regex Tester",
  description: "Visualize and test regular expressions in real time with live highlighting.",
};
    ...
    <main style={{ maxWidth: "72rem", margin: "0 auto", padding: "2.5rem 1.5rem" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "1rem", marginBottom: "1.5rem" }}>
        <div>
          ...
          <h1 className="gradient-text" style={{ fontSize: "1.75rem", fontWeight: 700, marginTop: "0.5rem" }}>Regex Tester</h1>
        </div>
