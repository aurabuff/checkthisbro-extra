...
import { GithubReadmeGenerator } from "@/components/projects/github-readme-generator";

export const metadata: Metadata = {
  title: "GitHub README Generator",
  description: "Create a stunning GitHub profile README with badges, stats cards, and social links.",
};
    ...
    <main style={{ maxWidth: "72rem", margin: "0 auto", padding: "2.5rem 1.5rem" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "1rem", marginBottom: "1.5rem" }}>
        <div>
          ...
          <h1 className="gradient-text" style={{ fontSize: "1.75rem", fontWeight: 700, marginTop: "0.5rem" }}>GitHub README Generator</h1>
        </div>
